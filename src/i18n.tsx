...
const translations = {
    ...
    home: {
      ...
      places: {
        eyebrow: 'JOYLANAR VA MAYDONLAR',
        title: 'Ta\'lim va ijodiy markazlar',
        subtitle: 'Ekspertlar, rassomlar va ijodkorlar uchun majmua',
        button: 'Joylar haqida batafsil',
        modalTitle: 'ART-klasterdagi joylar',
        modalHint: 'Batafsil ma\'lumot uchun bo\'limni tanlang',
        close: 'Yopish',
        card: {
          description: 'Tavsif',
          example: 'O\'zbekistondan misol',
          result: 'Ahamiyati va natijasi',
          backButton: 'Ro\'yxatga qaytish',
        },
      },
      artistModal: {
        worksHeading: 'Asarlar',
      ...
      footer: {
        ...
        phone: '+998950881760',
        city: "Mironshoh ko'chasi 123, Toshkent",
        region: "O'zbekiston",
      },
    },
    login: {
    ...
    home: {
      ...
      places: {
        eyebrow: 'МЕСТА И ПРОСТРАНСТВА',
        title: 'Образовательные и творческие центры',
        subtitle: 'Комплекс площадок для экспертов, художников и творцов',
        button: 'Подробнее о местах',
        modalTitle: 'Места в АРТ-кластере',
        modalHint: 'Выберите раздел, чтобы узнать больше',
        close: 'Закрыть',
        card: {
          description: 'Описание',
          example: 'Пример из Узбекистана',
          result: 'Значение и результат',
      ...
      footer: {
        ...
        email: 'odylabduhamidov@gmail.com',
        phone: '+998950881760',
        city: 'Mironshoh ko\'chasi 123, Тошкент',
        region: 'Узбекистан',
      },
    },
    en: {
    ...
    home: {
      ...
      places: {
        ...
        title: 'Educational and creative centers',
        subtitle: 'A complex of venues for experts, artists and creators',
        button: 'Learn more about places',
        modalTitle: 'Places in the ART cluster',
        modalHint: 'Choose a section to learn more',
        close: 'Close',
        card: {
          description: 'Description',
          example: 'Example from Uzbekistan',
          result: 'Importance and result',
      ...
      footer: {
        ...
        email: 'odylabduhamidov@gmail.com',
        phone: '+998950881760',
        city: 'Mironshoh ko\'chasi 123, Tashkent',
